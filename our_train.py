...
def train(args):
    ...
    content_folder1 = 'data/train650/train650-LR'
    information_folder = 'data/train650/train650-HR'
    ...
    for epoch in range(args.epoch):
      ...
      if epoch % 20 ==0:
        ...
        torch.save(model.state_dict(), 'model' +'/our_enhancement{}.pth'.format(epoch))
